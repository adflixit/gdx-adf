...
/**
 * Hardcoded xissburg's blur shader.
 */
public class DefaultBlurShader {
  public static final String BLURH_VERT =
  ...
  public static final String BLURV_VERT =
      "attribute vec4 a_position;\n" +
      "attribute vec4 a_color;\n" +
      "attribute vec2 a_texCoord0;\n" +
      "\n" +
  ...
  public static final String FLAT_BLURH_VERT =
      "attribute vec4 a_position;\n" +
      "attribute vec4 a_color;\n" +
      "attribute vec2 a_texCoord0;\n" +
      "\n" +
  ...
  public static final String FLAT_BLURV_VERT =
      "attribute vec4 a_position;\n" +
      "attribute vec4 a_color;\n" +
      "attribute vec2 a_texCoord0;\n" +
      "\n" +
  ...
  public static final String FLAT_BLUR_FRAG =
      "#ifdef GL_ES\n" +
      "  #define LOWP lowp\n" +
      "  precision mediump float;\n" +
      "#else\n" +
