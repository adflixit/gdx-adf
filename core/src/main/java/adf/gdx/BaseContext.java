...
public abstract class BaseContext<G extends BaseGame> implements InputProcessor, GestureListener {
  ...
  public void setupVignette() {
    $setupVignette(1).start(tweenMgr);
  }
  ...
  public Tween $setupSheers(Color clr, float v) {
    return overlay.$setupSheers(clr, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupSheers(float v) {
    return $setupSheers(onyx, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupSheers() {
    return $setupSheers(onyx, 1);
  }
  ...
  public Tween $tweenBlackoutsColor(Color clr, float d) {
    return overlay.$tweenBlackoutsColor(clr, d);
  }
   ...
   * @return tween handle
   */
  public Tween $tweenBlackoutsColor(Color clr) {
    return $tweenBlackoutsColor(clr, C_D);
  }
  ...
  public Tween $fadeBlackouts(Color clr, float v, float d) {
    return overlay.$fadeBlackouts(clr, v, d);
  }
   ...
   * @return tween handle
   */
  public Tween $fadeBlackouts(Color clr, float v) {
    return $fadeBlackouts(clr, v, C_D);
  }
   ...
   * @return tween handle
   */
  public Tween $fadeBlackouts(float v, float d) {
    return $fadeBlackouts(onyx, v, d);
  }
   ...
   * @return tween handle
   */
  public Tween $fadeBlackouts(float v) {
    return $fadeBlackouts(onyx, v, C_D);
  }
   ...
   * @return tween handle
   */
  public Tween $fadeBlackoutsIn() {
    return $fadeBlackouts(1);
  }
  ...
  public Tween $fadeBlackoutsOut(float d) {
    return overlay.$fadeBlackoutsOut(d);
  }
   ...
   * @return tween handle
   */
  public Tween $fadeBlackoutsOut() {
    return $fadeBlackoutsOut(C_D);
  }
   ...
   * @return tween handle
   */
  public Timeline $fadeBlackoutsInOut(Color clr, float v, float id, float od) {
    return Timeline.createSequence()
           .push($fadeBlackouts(clr, v, id))
           .push($fadeBlackoutsOut(od));
  }
   ...
   * @return tween handle
   */
  public Timeline $fadeBlackoutsInOut(Color clr, float v) {
    return $fadeBlackoutsInOut(clr, v, C_TD, C_BD);
  }
  ...
  public Tween $setupBlackouts(Color clr, float v) {
    return overlay.$setupBlackouts(clr, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupBlackouts(float v) {
    return $setupBlackouts(onyx, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupBlackouts() {
    return $setupBlackouts(onyx, 1);
  }
  ...
  public Tween $setupTint(Color clr, float v) {
    return overlay.$setupTint(clr, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupTint(float v) {
    return $setupTint(onyx, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupTint() {
    return $setupTint(onyx, 1);
  }
  ...
  public Tween $setupVignette(Color clr, float v) {
    return overlay.$setupVignette(clr, v);
  }
   ...
   * @return tween handle
   */
  public Tween $setupVignette() {
    return $setupVignette(onyx, 1);
  }
